...
export const dict = {
  en: {
    ...
    'settings.memorySyncNow': 'Sync now',
    'settings.memorySyncResult': '{n} clips synced to cloud memory',
    'settings.dailyReport': 'Daily report to Notion',
    'settings.notionDbId': 'Notion Database ID',
    'settings.notionDbIdPlaceholder': '32-char ID from the Notion database URL',
    'settings.dailyReportNow': 'Generate now',
    'settings.dailyReportResult': 'Daily report for {day} generated',
  ...
  'zh-CN': {
    ...
    'settings.memorySyncNow': '立即同步',
    'settings.memorySyncResult': '{n} 条摘录已同步到云端记忆',
    'settings.dailyReport': '每日日报到 Notion',
    'settings.notionDbId': 'Notion 数据库 ID',
    'settings.notionDbIdPlaceholder': 'Notion 数据库 URL 中的 32 位 ID',
    'settings.dailyReportNow': '立即生成',
    'settings.dailyReportResult': '{day} 的日报已生成',
    'nav.settings': '设置',
    'nav.privacy': '隐私',
    'nav.clips': '摘录',
  ...
  'zh-TW': {
    ...
    'settings.memorySyncNow': '立即同步',
    'settings.memorySyncResult': '{n} 條摘錄已同步到雲端記憶',
    'settings.dailyReport': '每日日報至 Notion',
    'settings.notionDbId': 'Notion 資料庫 ID',
    'settings.notionDbIdPlaceholder': 'Notion 資料庫 URL 中的 32 位 ID',
    'settings.dailyReportNow': '立即產生',
    'settings.dailyReportResult': '{day} 的日報已產生',
    'nav.settings': '設定',
    'nav.privacy': '隱私',
    'nav.clips': '摘錄',
  ...
  ja: {
    ...
    'settings.memorySyncNow': '今すぐ同期',
    'settings.memorySyncResult': '{n} 件のクリップをクラウドメモリに同期しました',
    'settings.dailyReport': 'Notion へのデイリーレポート',
    'settings.notionDbId': 'Notion データベース ID',
    'settings.notionDbIdPlaceholder': 'Notion データベース URL 内の 32 桁 ID',
    'settings.dailyReportNow': '今すぐ生成',
    'settings.dailyReportResult': '{day} のレポートを生成しました',
    'nav.settings': '設定',
    'nav.privacy': 'プライバシー',
    'nav.clips': 'クリップ',
