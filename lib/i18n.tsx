...
export const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'privacy.collect.body': 'Your preferences, connection credentials and saved clips, stored locally via the browser storage API and never uploaded by us:',
  ...
  'zh-CN': {
    ...
    'privacy.collect.body': '你的偏好设置、连接凭证与保存的摘录，通过浏览器 storage API 保存在本地，我们绝不上传：',
  ...
  'zh-TW': {
    ...
    'privacy.collect.body': '你的偏好設定、連線憑證與儲存的摘錄，透過瀏覽器 storage API 保存在本機，我們絕不上傳：',
  ...
  ja: {
    ...
    'privacy.collect.body': '設定、接続認証情報、保存したクリップはブラウザの storage API でローカルに保存され、我々がアップロードすることはありません：',
