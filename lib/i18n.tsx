...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'widget.send': 'Send',
    'widget.error.unconfigured': 'Not configured. Fill in the server, PAT, Agent ID and Environment ID on the Settings page.',
    ...
    'settings.serverUrl': 'Backend Server',
  ...
  'zh-CN': {
    ...
    'widget.send': '发送',
    'widget.error.unconfigured': '尚未配置。请到设置页填写服务器地址、PAT、Agent ID 和环境 ID。',
  ...
  'zh-TW': {
    ...
    'widget.send': '傳送',
    'widget.error.unconfigured': '尚未設定。請到設定頁填寫伺服器位址、PAT、Agent ID 與環境 ID。',
  ...
  ja: {
    ...
    'widget.send': '送信',
    'widget.error.unconfigured': '未設定です。設定ページでサーバー、PAT、Agent ID、環境 ID を入力してください。',
