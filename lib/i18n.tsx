...
export const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'clips.export.md': 'Export Markdown',
    'clips.export.json': 'Export JSON',
    'clips.tagsPlaceholder': 'Tags (comma separated)…',
    'settings.mdTemplate': 'Markdown Export Template',
    'settings.mdTemplateHint': 'Variables: {{title}} {{url}} {{text}} {{fullText}} {{notes}} {{tags}} {{category}} {{author}} {{description}} {{published}} {{createdAt}}',
    ...
    'clips.copyLink': 'Copy highlight link',
    'settings.categories': 'Knowledge Categories',
  ...
  'zh-CN': {
    ...
    'clips.export.md': '导出 Markdown',
    'clips.export.json': '导出 JSON',
    'clips.tagsPlaceholder': '标签（逗号分隔）…',
    'settings.mdTemplate': 'Markdown 导出模板',
    'settings.mdTemplateHint': '可用变量：{{title}} {{url}} {{text}} {{fullText}} {{notes}} {{tags}} {{category}} {{author}} {{description}} {{published}} {{createdAt}}',
    'clips.search': '搜索摘录…',
    'clips.delete': '删除摘录',
    ...
    'clips.copyLink': '复制高亮链接',
    'settings.categories': '分类类别',
  ...
  'zh-TW': {
    ...
    'clips.export.md': '匯出 Markdown',
    'clips.export.json': '匯出 JSON',
    'clips.tagsPlaceholder': '標籤（逗號分隔）…',
    'settings.mdTemplate': 'Markdown 匯出範本',
    'settings.mdTemplateHint': '可用變數：{{title}} {{url}} {{text}} {{fullText}} {{notes}} {{tags}} {{category}} {{author}} {{description}} {{published}} {{createdAt}}',
    'clips.search': '搜尋摘錄…',
    'clips.delete': '刪除摘錄',
    ...
    'clips.copyLink': '複製反白連結',
    'settings.categories': '分類類別',
  ...
  ja: {
    ...
    'clips.export.md': 'Markdown をエクスポート',
    'clips.export.json': 'JSON をエクスポート',
    'clips.tagsPlaceholder': 'タグ（カンマ区切り）…',
    'settings.mdTemplate': 'Markdown エクスポートテンプレート',
    'settings.mdTemplateHint': '利用可能な変数：{{title}} {{url}} {{text}} {{fullText}} {{notes}} {{tags}} {{category}} {{author}} {{description}} {{published}} {{createdAt}}',
    ...
    'clips.copyLink': 'ハイライトリンクをコピー',
    'settings.categories': '分類カテゴリ',
