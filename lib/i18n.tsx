...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'widget.send': 'Send',
    'widget.reply': 'Prototype received: “{message}”. The Agent response will appear here once connected.',
    'widget.note': 'Interactive prototype · page access is not connected',
  ...
  'zh-CN': {
    ...
    'widget.send': '发送',
    'widget.reply': '原型已收到：“{message}”。接入 Agent 后，回答会显示在这里。',
    'widget.note': '交互原型 · 暂未读取页面',
    'settings.title': '设置',
  ...
  'zh-TW': {
    ...
    'widget.send': '傳送',
    'widget.reply': '原型已收到：「{message}」。接入 Agent 後，回答會顯示在這裡。',
    'widget.note': '互動原型 · 尚未讀取頁面',
    'settings.title': '設定',
  ...
  ja: {
    ...
    'widget.send': '送信',
    'widget.reply': 'プロトタイプが受け取りました：「{message}」。Agent 接続後、回答はここに表示されます。',
    'widget.note': '操作プロトタイプ · ページ読み取りは未接続',
    'settings.title': '設定',
